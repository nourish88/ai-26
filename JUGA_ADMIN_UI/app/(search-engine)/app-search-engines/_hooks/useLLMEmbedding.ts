...
import { createAppSearchEnginesMutationOptions, deleteAppSearchEnginesMutationOptions, updateAppSearchEnginesMutationOptions } from "./MutationOptions";
...
export function useCreateLLMEmbedding() {
  ...
  return useMutation(createAppSearchEnginesMutationOptions(queryClient));
}
...
export function useUpdateLLMEmbedding() {
  const queryClient = useQueryClient();
  return useMutation(updateAppSearchEnginesMutationOptions(queryClient));
}
...
export function useDeleteLLMEmbedding() {
  const queryClient = useQueryClient();
  return useMutation(deleteAppSearchEnginesMutationOptions(queryClient));
}
