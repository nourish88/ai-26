...
namespace Juga.DataAudit.PostreSql.Configurations;
        ...
        public class DataAuditPostgreSqlOptions
        {
            /// <summary>
            /// DataAuditPostgreSqlOptions ın konfigurasyonda bulunduğu section bilgisi. 
            /// </summary>
            public const string DataAuditPostgreSqlOptionsSection = "Juga:DataAudit:PostgreSql";
            /// <summary>
            /// Data Auidt PostgreSql için connection string bilgisi.
            /// </summary>
            public virtual string ConnectionString { get; set; }
            /// <summary>
            /// Audit kayıtlarının saklanacağı tablonun şema bilgisi. Default public.
            /// </summary>
            public virtual string SchemaName { get; set; } = "public";
            /// <summary>
